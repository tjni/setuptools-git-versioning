...
-------------------
+-------------------------------------+-----------------+----------------+--------------------+
| Package/Function                    | Latest release  | License        | PEP 440 compatible |
+=====================================+=================+================+====================+
...
-------------------
+-------------------------------------+-----+-----------+-------------------------------+
| Package/Function                    | Git | Mercurial | Can be used in git submodules |
+=====================================+=====+===========+===============================+
...
------------
+-------------------------------------+---------------+-------+-----------+-------+------------+
| Package/Function                    | Documentation | Tests | Changelog | CI/CD | pre-commit |
+=====================================+===============+=======+===========+=======+============+
...
----------------------
+-------------------------------------+------------------+------------+------------------+--------------+
| Package/Function                    | Python 3 support | Type hints | Python 2 support | PyPy support |
+=====================================+==================+============+==================+==============+
...
-----------
+-------------------------------------+-------+-------+---------+
| Package/Function                    | Linux | MacOS | Windows |
+=====================================+=======+=======+=========+
...
--------------
+-------------------------------------+---------------+-----------+----------+--------+
| Package/Function                    | Commits count | Short SHA | Full SHA | Branch |
+=====================================+===============+===========+==========+========+
...
+-------------------------------------+---------------+------------------+-------------------+--------------+
| Package/Function                    | Tag timestamp | Commit timestamp | Current timestamp | Env variable |
+=====================================+===============+==================+===================+==============+
...
--------------------
+-------------------------------------+------------------------+---------------+-----------------+
| Package/Function                    | Dev (distance) version | Dirty version | Initial version |
+=====================================+========================+===============+=================+
| setuptools-git-versioning           |           yes          |      yes      |       yes       |
+-------------------------------------+------------------------+---------------+-----------------+
...
---------------------
+-------------------------------------+----------------+---------------+-------------------------+
| Package/Function                    | Read from file | Write to file | Use file commit history |
+=====================================+================+===============+=========================+
...
-------------------------
+-------------------------------------+-------------------------+------------------------+
| Package/Function                    | Execute module function | Import module variable |
+=====================================+=========================+========================+
...
----
+-------------------------------------+-------------------------------+------------------------------+---------------------+
| Package/Function                    | Get module version in runtime | Reuse functions in your code | Supports extensions |
+=====================================+===============================+==============================+=====================+
